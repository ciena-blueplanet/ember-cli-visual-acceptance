...
export default function(imageName, height = null, width = null, misMatchPercentageMargin = 0.00) {
    describe('Visual Acceptance Test:', function() {
        it('Image should be above mismatch percentage margin', function(callback) {
            html2canvas(document.getElementById('ember-testing-container'), {
                height: height,
                width: width
